...
enum opt_code
{
  ...
  OPT_mglibc = 1179,                         /* -mglibc */
  OPT_mgp32 = 1180,                          /* -mgp32 */
  OPT_mgp64 = 1181,                          /* -mgp64 */
  OPT_mgpopt = 1182,                         /* -mgpopt */
  OPT_mhard_float = 1183,                    /* -mhard-float */
  OPT_mimadd = 1184,                         /* -mimadd */
  OPT_minterlink_compressed = 1185,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1186,              /* -minterlink-mips16 */
  OPT_mips = 1187,                           /* -mips */
  OPT_mips16 = 1188,                         /* -mips16 */
  OPT_mips3d = 1189,                         /* -mips3d */
  OPT_mllsc = 1190,                          /* -mllsc */
  OPT_mlocal_sdata = 1191,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1192,                    /* -mlong-calls */
  OPT_mlong32 = 1193,                        /* -mlong32 */
  OPT_mlong64 = 1194,                        /* -mlong64 */
  OPT_mlra = 1195,                           /* -mlra */
  OPT_mmad = 1196,                           /* -mmad */
  OPT_mmcount_ra_address = 1197,             /* -mmcount-ra-address */
  OPT_mmcu = 1198,                           /* -mmcu */
  OPT_mmemcpy = 1199,                        /* -mmemcpy */
  OPT_mmicromips = 1200,                     /* -mmicromips */
  OPT_mmt = 1201,                            /* -mmt */
  OPT_mmusl = 1202,                          /* -mmusl */
  OPT_mnan_ = 1203,                          /* -mnan= */
  OPT_mno_float = 1204,                      /* -mno-float */
  OPT_mno_flush_func = 1205,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1206,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1207,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1208,                     /* -mno-mips3d */
  OPT_modd_spreg = 1209,                     /* -modd-spreg */
  OPT_mpaired_single = 1210,                 /* -mpaired-single */
  OPT_mplt = 1211,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1212,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1213,               /* -mrelax-pic-calls */
  OPT_mshared = 1214,                        /* -mshared */
  OPT_msingle_float = 1215,                  /* -msingle-float */
  OPT_msmartmips = 1216,                     /* -msmartmips */
  OPT_msoft_float = 1217,                    /* -msoft-float */
  OPT_msplit_addresses = 1218,               /* -msplit-addresses */
  OPT_msym32 = 1219,                         /* -msym32 */
  OPT_msynci = 1220,                         /* -msynci */
  OPT_mtune_ = 1221,                         /* -mtune= */
  OPT_muclibc = 1222,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1223,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1224,                          /* -mvirt */
  OPT_mvr4130_align = 1225,                  /* -mvr4130-align */
  OPT_mxgot = 1226,                          /* -mxgot */
  OPT_mxpa = 1227,                           /* -mxpa */
  OPT_n = 1228,                              /* -n */
  OPT_no_canonical_prefixes = 1229,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1230,              /* -no-integrated-cpp */
  OPT_noasmopt = 1231,                       /* -noasmopt */
  OPT_nocpp = 1232,                          /* -nocpp */
  OPT_nodefaultlibs = 1233,                  /* -nodefaultlibs */
  ...
  OPT_o = 1238,                              /* -o */
  OPT_p = 1239,                              /* -p */
  OPT_pass_exit_codes = 1240,                /* -pass-exit-codes */
  /* OPT_pedantic = 1241, */                 /* -pedantic */
  OPT_pedantic_errors = 1242,                /* -pedantic-errors */
  OPT_pg = 1243,                             /* -pg */
  OPT_pie = 1244,                            /* -pie */
  OPT_pipe = 1245,                           /* -pipe */
  OPT_posix = 1246,                          /* -posix */
  OPT_print_file_name_ = 1247,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1248,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1249,          /* -print-multi-directory */
  OPT_print_multi_lib = 1250,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1251,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1252,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1253,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1254,               /* -print-prog-name= */
  OPT_print_search_dirs = 1255,              /* -print-search-dirs */
  OPT_print_sysroot = 1256,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1257,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1258,                        /* -profile */
  OPT_pthread = 1259,                        /* -pthread */
  OPT_quiet = 1260,                          /* -quiet */
  OPT_r = 1261,                              /* -r */
  OPT_rdynamic = 1262,                       /* -rdynamic */
  OPT_remap = 1263,                          /* -remap */
  OPT_s = 1264,                              /* -s */
  OPT_s_bc_abi = 1265,                       /* -s-bc-abi */
  OPT_save_temps = 1266,                     /* -save-temps */
  OPT_save_temps_ = 1267,                    /* -save-temps= */
  OPT_shared = 1268,                         /* -shared */
  OPT_shared_libgcc = 1269,                  /* -shared-libgcc */
  /* OPT_specs = 1270, */                    /* -specs */
  OPT_specs_ = 1271,                         /* -specs= */
  OPT_static = 1272,                         /* -static */
  OPT_static_libasan = 1273,                 /* -static-libasan */
  OPT_static_libgcc = 1274,                  /* -static-libgcc */
  OPT_static_libgcj = 1275,                  /* -static-libgcj */
  OPT_static_libgfortran = 1276,             /* -static-libgfortran */
  OPT_static_libgo = 1277,                   /* -static-libgo */
  OPT_static_liblsan = 1278,                 /* -static-liblsan */
  OPT_static_libmpx = 1279,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1280,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1281,               /* -static-libstdc++ */
  OPT_static_libtsan = 1282,                 /* -static-libtsan */
  OPT_static_libubsan = 1283,                /* -static-libubsan */
  /* OPT_std_c__03 = 1284, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1285, */                /* -std=c++0x */
  OPT_std_c__11 = 1286,                      /* -std=c++11 */
  OPT_std_c__14 = 1287,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1288, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1289, */                /* -std=c++1y */
  OPT_std_c__1z = 1290,                      /* -std=c++1z */
  OPT_std_c__98 = 1291,                      /* -std=c++98 */
  OPT_std_c11 = 1292,                        /* -std=c11 */
  /* OPT_std_c1x = 1293, */                  /* -std=c1x */
  /* OPT_std_c89 = 1294, */                  /* -std=c89 */
  OPT_std_c90 = 1295,                        /* -std=c90 */
  OPT_std_c99 = 1296,                        /* -std=c99 */
  /* OPT_std_c9x = 1297, */                  /* -std=c9x */
  OPT_std_f2003 = 1298,                      /* -std=f2003 */
  OPT_std_f2008 = 1299,                      /* -std=f2008 */
  OPT_std_f2008ts = 1300,                    /* -std=f2008ts */
  OPT_std_f95 = 1301,                        /* -std=f95 */
  OPT_std_gnu = 1302,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1303, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1304, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1305,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1306,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1307, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1308, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1309,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1310,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1311,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1312, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1313, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1314,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1315,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1316, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1317, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1318,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1319, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1320, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1321, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1322,                     /* -std=legacy */
  OPT_symbolic = 1323,                       /* -symbolic */
  OPT_t = 1324,                              /* -t */
  OPT_time = 1325,                           /* -time */
  OPT_time_ = 1326,                          /* -time= */
  OPT_tno_android_cc = 1327,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1328,                 /* -tno-android-ld */
  OPT_traditional = 1329,                    /* -traditional */
  OPT_traditional_cpp = 1330,                /* -traditional-cpp */
  OPT_trigraphs = 1331,                      /* -trigraphs */
  OPT_u = 1332,                              /* -u */
  OPT_undef = 1333,                          /* -undef */
  OPT_v = 1334,                              /* -v */
  OPT_version = 1335,                        /* -version */
  OPT_w = 1336,                              /* -w */
  OPT_wrapper = 1337,                        /* -wrapper */
  OPT_x = 1338,                              /* -x */
  OPT_z = 1339,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
