...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/root/buildroot-2017.05/output/host/usr/mips-buildroot-linux-uclibc/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/root/buildroot-2017.05/output/host/usr/mips-buildroot-linux-uclibc/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
